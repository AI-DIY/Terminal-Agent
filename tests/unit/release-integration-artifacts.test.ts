...
describe('release integration artifact guard', () => {
  it('keeps v3.2.4 package metadata, installer artifact naming, and release notes synchronized', () => {
    ...
    expect(releaseNotes.startsWith('# Terminal-Agent v3.2.4')).toBe(true)
    expect(releaseNotes).toContain('Terminal-Agent-Quick-Install-3.2.4.zip')
