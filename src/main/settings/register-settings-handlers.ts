...
import { rendererModelSettingsInputSchema } from '../../shared/validation'
...
export function registerSettingsHandlers(models: ModelSettingsSource, rules: RegexRuleSource, sender: WebContents): () => void {
