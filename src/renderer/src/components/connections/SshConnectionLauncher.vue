...
<template>
  <section class="ssh-launcher" :class="`appearance-${appearance}`" :aria-labelledby="launcherTitleId">
    ...
    <div class="launcher-body">
      ...
      <div class="launcher-scroll-region" role="region" aria-label="SSH 连接内容" tabindex="0">
