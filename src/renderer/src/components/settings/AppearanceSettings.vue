  ...
  <section class="settings-panel appearance" aria-labelledby="appearance-title">
    ...
    <section class="theme-band" aria-label="工作台主题">
      <div class="theme-options" role="group" aria-label="工作台主题">
        ...
        <button type="button" :class="{ selected: layout.state.theme === 'imperial-gold' }" :aria-pressed="layout.state.theme === 'imperial-gold'" @click="saveTheme('imperial-gold')"><span class="theme-swatch imperial-gold" aria-hidden="true"><i /><i /></span><span><strong>帝王金</strong><small>沉稳的金色深色主题，突出重点信息</small></span></button>
...
.theme-band { padding: 8px 2px 20px; }.theme-options { display: grid; grid-template-columns: repeat(3,minmax(0,1fr)); gap: 14px; max-width: 860px; }
...
.theme-swatch.imperial-gold { border-color: #876923; background: #33230c; }.theme-swatch.imperial-gold::before { border-color: #75571d; background: #4b3512; }.theme-swatch.imperial-gold::after { border-color: #8d6d27; background: #211706; box-shadow: inset 0 12px 0 #4b3512; }.theme-swatch.imperial-gold i:first-child { border-color: #6b501b; background: #2a1d09; }.theme-swatch.imperial-gold i:last-child { background: #38270d; }
