...
<style scoped>
.file-transfer-panel { position: relative; display: grid; grid-template-rows: auto auto auto minmax(82px, 1fr) auto auto; gap: 6px; box-sizing: border-box; width: 100%; min-width: 0; min-height: 150px; max-height: 232px; padding: 8px 10px 9px; border-top: 1px solid var(--line); background: var(--panel); color: var(--text); }
...
.file-transfer-browser,.file-transfer-log { display: grid; grid-template-rows: auto minmax(0, 1fr); min-width: 0; min-height: 0; overflow: hidden; border: 1px solid var(--line-soft); background: var(--surface); }.section-heading { display: flex; align-items: center; justify-content: space-between; gap: 8px; min-width: 0; min-height: 23px; padding: 0 7px; border-bottom: 1px solid var(--line-soft); color: var(--text-strong); font-size: 9px; font-weight: 650; }.section-heading span:last-child { color: var(--muted); font-size: 8px; font-weight: 500; }
