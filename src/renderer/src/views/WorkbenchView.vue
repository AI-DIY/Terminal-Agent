...
.empty-state { display: grid; align-content: safe center; box-sizing: border-box; height: 100%; min-width: 0; min-height: 0; overflow: hidden; padding: clamp(28px, 5vh, 64px) clamp(20px, 3vw, 48px); background: var(--surface); }
