...
<style scoped>
.settings { display: grid; grid-template-rows: 56px minmax(0, 1fr); width: 100vw; min-width: 0; height: 100vh; min-height: 0; margin: 0; overflow: hidden; border: 0; border-radius: 0; background: var(--surface); color: var(--text); box-shadow: none; }
